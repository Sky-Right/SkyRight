    ...
    sections: [
        ...
        items: [
          {
            ...
            right: "2023 — 2027（预计）",
            badges: ["GPA 3.61", "排名 4/60", "CET-4 / CET-6"],
            bullets: [
        ...
        items: [
          {
            ...
            bullets: [
              ...
              "我的贡献：作为共一作者，负责整体方法设计与算法框架构建，完成核心模块 MFF 与 TCL 的代码实现，搭建实验体系并完成主要实验分析，同时负责论文主体撰写及主要图表绘制（通讯作者：郭继鹏）。",
          ...
          },
          {
            ...
            right: "Expert Systems with Applications（ESWA，中科院一区 Top，IF=8.7）· Revise（独立一作）",
            ...
            bullets: [
              ...
              "投稿状态：Revise（一审大修修改中，主要进行实验补充与表述细化）"
            ]
          },
          {
            title: "Disentangling Spatial, Temporal, and Space-Weather Contributions to Spacecraft Anomaly States: A Case-Control Analysis of GOES-16/17",
            right: "Aerospace, Astronautics & Space Science · Under Review（第一作者）",
            badges: ["Spacecraft Anomaly", "Case-Control Analysis", "GOES-16/17", "Space Weather"],
            bullets: [
              "项目简介：面向地球同步轨道航天器异常状态监测问题，以 GOES-16/17 EXIS Space Wire 异常为子系统级验证对象，构建卫星分层的 case-control 分析框架，联合建模轨道--光照几何、近期异常历史与空间天气驱动因素，分析空间、时间与空间天气因素对异常状态的相对贡献。",
              "我的贡献：负责公开异常时间戳整理、星历几何与光照特征构建、OMNI 空间天气变量融合、时间序列训练测试划分与特征选择实验，参与模型分析、结果解释与论文撰写（通讯作者：郭旦怀）。",
              "投稿状态：Under Review"
            ]
          },
          {
            title: "Multi-scale Spatial Regionalization and Boundedly Rational Route Simulation Framework for Electric Vehicle Charging Station Expansion",
            right: "Target Journal: Geoinformatica（CCF-B）· Manuscript in Preparation",
            badges: ["Spatial Regionalization", "EV Charging", "Route Simulation", "Game Theory"],
            bullets: [
              "项目简介：面向电动汽车充电站扩展中的空间布局优化问题，构建融合多尺度空间区域化与有限理性路径选择模拟的分析框架，在地理信息约束下联合建模用户充电需求满足、企业收益与政策侧拥堵控制目标，形成三方博弈下的站点扩展决策方法。",
              "我的贡献：依托地理信息学交叉视角，参与问题定义、模型构建与实验推进，当前正在补充实验，论文拟近期投稿至 Geoinformatica。"
            ]
          },
          {
      ...
      },
      {
        ...
        contests: [
          ...
          {
            title: "中国大学生工程能力与创新实践大赛",
            award: "国家级二等奖",
            time: "2024.11 — 2025.08",
            bullets: [
              "赛道：\"智能+\" 赛道｜生活垃圾智能分类赛项（自动判别与分类投放；强调系统集成与工程实现）。",
              "项目简介：自主设计并制作单投入口智能垃圾分类装置，实现对多类城市生活垃圾的自动识别、分类投放与状态显示；包含传感/视觉识别、执行机构（分拣/压缩）、控制系统与显示交互等模块，并在现场任务流程中完成分类与展示要求。",
              "我的贡献：负责完整视觉部分搭建，自主设计整套视觉识别方案，包括数据处理、模型选择与训练流程；负责模型训练与调参、轻量化与部署封装，面向边缘 AI 计算运行；联调识别—控制链路，提升现场任务的稳定性与实时性，并输出可复用的部署脚本与测试用例，将经验整理为完整实现文档并开源给本校低年级同学参考。"
            ]
          },
          {
            title: "全国大学生嵌入式系统与芯片设计大赛（龙芯赛道）",
            award: "国家级三等奖",
            time: "2025.05 — 2025.08",
            bullets: [
              "选题方向：智能车辅助驾驶。基于龙芯 2K0300 久久派开发板，围绕阿克曼转向小车完成自主导航、车道保持、自动泊车等任务，要求融合视觉与激光雷达感知，并在指定赛道中实现稳定无人驾驶。",
          ...
          },
          {
            ...
            bullets: [
              "赛道：软件应用与开发类（面向实际场景的软件系统设计、实现与应用价值展示）。",
      ...
      },
      {
        ...
        items: [
          {
            title: "学工办学工数据中心｜信息系统运维",
            right: "2023.09 — 至今",
            badges: ["Data Ops", "System Development", "Testing", "Deployment"],
            bullets: [
              "负责学工相关数据库的日常对接、数据整理与维护，参与校内学工系统的需求梳理、测试与迭代。",
              "参与第二课堂系统、勤工助学系统、军训系统等多个项目的开发与测试工作，相关系统目前仍在校内持续使用。"
            ]
          }
        ]
      },
        ...
        items: [
          {
            title: "科研技能",
            bullets: [
              "熟悉 LaTeX 排版，能够完成论文写作、公式/图表排版与参考文献管理。",
              "熟悉 PyTorch，能够完成实验搭建、模型训练、论文复现与结果分析。",
              "具备机器学习、深度学习与计算机视觉实验经验，能够进行数据处理、实验设计与结果分析。"
            ]
          },
          {
            title: "开发技能",
            bullets: [
              "熟悉 Python、Java、C/C++、JavaScript 等编程语言，具备良好的代码实现与工程协作能力。",
    ...
    sections: [
        ...
        items: [
          {
            ...
            badges: ["GPA 3.61", "Rank 4/60", "CET-4 / CET-6"],
            bullets: [
      ...
      },
      {
        ...
        items: [
          {
            title: "Multi-order Filter Fusion and Triple Contrastive Learning for Attribute Graph Clustering",
            right: "IJCNN 2026 (CCF-C) · Oral Accepted (Co-first Author)",
            badges: ["MT-AGC", "Graph Clustering", "Contrastive Learning", "Topology Augmentation"],
            bullets: [
          ...
          {
            title: "CRIC-Net: Decision-Oriented Calibrated Forecasting for Sparse User-Level Demand in Resource-Constrained Service Systems",
            right: "Expert Systems with Applications (ESWA, CAS Q1 Top, IF=8.7) · Revise (Sole First Author)",
            badges: ["CRIC-Net", "Decision-Oriented Forecasting", "Calibration", "Sparse User-level Demand", "SAA Planning"],
            bullets: [
              ...
              "Submission Status: Revise (major revision; currently addressing experimental supplements and presentation refinements)."
            ]
          },
          {
            title: "Disentangling Spatial, Temporal, and Space-Weather Contributions to Spacecraft Anomaly States: A Case-Control Analysis of GOES-16/17",
            right: "Aerospace, Astronautics & Space Science · Under Review (First Author)",
            badges: ["Spacecraft Anomaly", "Case-Control Analysis", "GOES-16/17", "Space Weather"],
            bullets: [
              "Project Summary: This work studies anomaly-state monitoring for geostationary spacecraft, using GOES-16/17 EXIS Space Wire anomalies as a subsystem-level validation case. It constructs a satellite-stratified case-control analysis framework and jointly models orbital-illumination geometry, recent anomaly history, and space-weather drivers to disentangle the relative contributions of spatial, temporal, and space-weather factors.",
              "My Contribution: Responsible for organizing public anomaly timestamps, constructing ephemeris geometry and illumination features, integrating OMNI space-weather variables, designing temporal train-test splits and feature-selection experiments, and participating in model analysis, result interpretation, and manuscript writing (corresponding author: Danhuai Guo).",
          ...
          },
          {
            ...
            badges: ["Spatial Regionalization", "EV Charging", "Route Simulation", "Game Theory"],
            bullets: [
              "Project Summary: This work addresses spatial layout optimization for electric-vehicle charging-station expansion by developing an analytical framework that combines multi-scale spatial regionalization with boundedly rational route-choice simulation. Under geographic-information constraints, it jointly models user charging-demand satisfaction, enterprise revenue, and policy-side congestion-control objectives, forming a site-expansion decision method under a tripartite game setting.",
              "My Contribution: From an interdisciplinary geoinformatics perspective, I participated in problem definition, model construction, and experimental advancement. The manuscript is currently being supplemented with additional experiments and is planned for submission to Geoinformatica."
            ]
          },
          {
            title: "Dynamic Decision Optimization for Resource Allocation under Finite Resource Competition",
      ...
      },
      {
        ...
        contests: [
          ...
          {
            title: "China Undergraduate Engineering Ability and Innovation Practice Competition",
      ...
      },
      {
        ...
        items: [
          {
            title: "Student Affairs Office Data Center | Information System Operations and Maintenance",
            right: "2023.09 — Present",
            badges: ["Data Ops", "System Development", "Testing", "Deployment"],
            bullets: [
              "Responsible for daily coordination, organization, and maintenance of student-affairs databases, and participated in requirement analysis, testing, and iteration of campus student-affairs systems.",
              "Participated in the development and testing of multiple systems, including the Second Classroom system, Work-Study system, and Military Training system, which are still in continuous use on campus."
            ]
          }
        ]
      },
        ...
        items: [
          {
            ...
            bullets: [
              "Familiar with LaTeX typesetting for academic writing, formulas, references, figures, and tables.",
              "Familiar with PyTorch, and able to build experiments, train models, reproduce papers, and analyze results.",
              "Possess experience in machine learning, deep learning, and computer vision experiments, including data processing, experimental design, and result analysis."
            ]
          },
          {
            title: "Development Skills",
            bullets: [
              "Familiar with Python, Java, C/C++, and JavaScript, with solid implementation skills and engineering collaboration ability.",
